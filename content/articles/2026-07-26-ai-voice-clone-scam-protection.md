...
review:
  ...
  no_fabrication: true
  policy_pass: true
  reviewed_at: "2026-07-27T01:25:00+05:30"
---

One rule beats every version of this scam: **hang up, and call the person back on a number you already have.** That works because it defeats the technology itself — a cloned voice, a spoofed caller ID, even a deepfaked video call all collapse the moment *you* dial a number you trust. Your ear will not save you: in controlled research, people spotted AI-cloned speech only about 73% of the time, and training barely helped ([Mai et al., PLOS ONE](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0285333)). The callback habit will.
...
1. **"Mom, I'm in trouble."** A voice that sounds exactly like your child or parent — cloned from a "short audio clip," in the FTC's words ([FTC alert](https://consumer.ftc.gov/consumer-alerts/2023/03/scammers-use-ai-enhance-their-family-emergency-schemes)) — needs money quietly, right now. (You'll see "3 seconds of audio is enough" online; that number comes from a Microsoft research paper, not from testing real scam tools. Assume any public clip of you is enough.)
...
3. **"It's your CFO. Wire it today."** The corporate version. In the most-cited case, a finance employee wired about US$25.6 million after a group video call where *everyone on screen* — CFO included — was a live deepfake ([CNN](https://edition.cnn.com/2024/02/04/asia/deepfake-cfo-scam-hong-kong-intl-hnk/index.html)). A face on video proves nothing in 2026.
...
- **India:** reported cybercrime losses jumped from ₹2,290 crore in 2022 to ₹7,465 crore in 2023 to **₹22,845.73 crore in 2024** — the Home Ministry's own reply to Parliament ([MHA, Lok Sabha](https://www.mha.gov.in/MHA1/Par2017/pdfs/par2025-pdfs/LS02122025/432.pdf)). The flip side: fast reporting works — over **₹8,189 crore was frozen** before scammers could withdraw it, across 23.6 lakh complaints ([MHA, Rajya Sabha](https://www.mha.gov.in/MHA1/Par2017/pdfs/par2026-pdfs/RS11022026/1349.pdf)).
- **US:** the FBI logged **$20.9 billion** in 2025 losses and created its first AI-fraud category: $893 million, including over $5 million specifically from voice-clone "distress" calls ([IC3 2025 report](https://www.ic3.gov/AnnualReport/Reports/2025_IC3Report.pdf)). Robocalls with AI voices are already illegal without consent ([FCC ruling](https://docs.fcc.gov/public/attachments/FCC-24-17A1.pdf)).
...
- **Slow everything down — strong, official.** The FBI calls it "Take a Beat" ([FBI](https://www.fbi.gov/how-we-can-help-you/scams-and-safety/common-frauds-and-scams)). Urgency is the scam's engine; a 60-second pause usually stalls it.
...
- **Report spam numbers on Chakshu — real but partial.** The Sanchar Saathi facility genuinely gets fraud numbers, handsets and WhatsApp accounts cut off ([PIB](https://pib.gov.in/PressReleaseIframePage.aspx?PRID=2083727)). It thins the flood; it doesn't stop a targeted call.
- **"I'll hear the robotic voice" — does not work.** That's the ~73% lab result again. Plan around procedure, not perception. Same lesson as [spotting AI images and videos](/articles/spot-ai-generated-images-videos/): check provenance, not vibes.
...
3. **Know RBI's clock:** report a third-party fraud within **3 working days** and your liability is zero; within 4–7 days it's capped (₹5,000–₹25,000 by account type); later, it's the bank's policy. Banks must provisionally re-credit within 10 working days ([RBI](https://www.rbi.org.in/commonman/English/Scripts/Notification.aspx?Id=2336)).
...
Two habits to keep forever: treat any "your bank calling to warn you" as fake until you've called the bank back yourself — banks don't verify transactions by cold-calling. And post less raw audio of yourself and your family; every public clip is free raw material, the same [privacy hygiene](/articles/ai-chatbot-data-privacy/) that applies to your chats. More evidence-graded guides on our [how-to and explainers](/topics/explainers/) hub.
